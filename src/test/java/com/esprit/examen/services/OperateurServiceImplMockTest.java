...
class OperateurServiceImplMockTest {
    ...
    Operateur user = new Operateur(1L,"Mrabet","Boubaker","336",null);

    @SuppressWarnings("serial")
    ArrayList<Operateur> listOperateurs = new ArrayList<Operateur>() {
        {
            add(new Operateur(2L,"Dridi", "ahmed", "456",null));
            add(new Operateur(3L,"Jlassi", "amir", "31@9",null));
        }
    };
    ...
    void testRetrieveOperateur(){
        ...
        assertNotNull(op1);
        log.info("Retrieve Operateur works !");
    }
    @Test
    @Order(1)
    ...
    void testDeleteOperateur()  {
        ...
        log.info("Delete Operateur works !");
    }
    @Test
    @Order(3)
    void testupdateOperateur( ) {
        ...
        log.info("Update Operateur works !");
    }
    ...
    void  testretrieveAllOperateurs(){
        ...
        assertNotNull(op);
        log.info("Retrieve all Operateur works !");
    }
