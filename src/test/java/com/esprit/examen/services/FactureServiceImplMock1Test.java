...
public class FactureServiceImplMock1Test {
    ...
    Facture   returned = new Facture(1L, 20f, 200f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null);

    List<Facture> list = new ArrayList<Facture>() {
        {
            add(new Facture(2L, 30f, 700f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null));
            add(new Facture(3L, 40f, 1000f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null));
        }
    };
    @Test
    ...
    public void testAddFactureMock() throws Exception {
        Facture input1 = new Facture (1L, 20f, 200f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null);
        Facture returned1 =  new  Facture (1L, 20f, 200f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null);
        //stub the data
    ...
    public void testCancelFactureMock() throws Exception {
        Facture  input = new Facture (1L, 20f, 200f, new Date(10 / 10 / 2022), new Date(10 / 10 / 2022), true,null,null,null);
